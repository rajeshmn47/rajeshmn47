...
I have strong Proficiency of Responsive Web Design, Functionality,Great Architecture i.e,Database schema, Authentication, REST API, Database, Git GitHub, Deploy, Elastic search ,Google Search, etc, and I try to write clean and scalable code,web security,owasp. I have been attached in programming for over five and a half years.
